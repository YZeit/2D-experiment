...
\end{array} ''')
    ...
    \end{array}''')
    st.subheader('New proposal: Choquet Tschebycheff (max-) norm')
    ...
    nu_1 = m1.continuous_var(lb=-10)
    nu_2 = m1.continuous_var(lb=-10)
    nu_3 = m1.continuous_var(lb=-10)
    ...
    #m.add_constraint(delta_x1 == ((objective[0]-z1_ref_star)/(f1_nadir-z1_ref_star)))
    #m.add_constraint(delta_x2 == ((objective[1]-z2_ref_star)/(f2_nadir-z2_ref_star)))
    #choquet_1 = lambda_1_1*delta_x1+lambda_1_2*delta_x2
    #choquet_2 = lambda_2_1*delta_x1+lambda_2_2*delta_x2

    #m.add_constraint(nu_1 >= choquet_1-(bigm*y_1))
    #m.add_constraint(nu_1 >= choquet_2-(bigm*y_2))
    ...
    m1.add_constraint(nu_1 >= lambda_1_1*((objective[0]-(z1_ref_star))/(f1_nadir-z1_ref_star)))
    m1.add_constraint(nu_1 >= lambda_1_2*((objective[1]-(z2_ref_star))/(f2_nadir-z2_ref_star)))
    m1.add_constraint(nu_2 >= lambda_2_1*((objective[0]-(z1_ref_star))/(f1_nadir-z1_ref_star)))
    m1.add_constraint(nu_2 >= lambda_2_2*((objective[1]-(z2_ref_star))/(f2_nadir-z2_ref_star)))

    #m1.add_constraint(nu_1 >= lambda_1_1*((objective[0]-z1_ref_star)/(f1_nadir-z1_ref_star))-(bigm*y_3))
    #m1.add_constraint(nu_1 >= lambda_1_2*((objective[1]-z2_ref_star)/(f2_nadir-z2_ref_star))-(bigm*y_4))
    #m1.add_constraint(nu_2 >= lambda_2_1*((objective[0]-z1_ref_star)/(f1_nadir-z1_ref_star))-(bigm*y_5))
    #m1.add_constraint(nu_2 >= lambda_2_2*((objective[1]-z2_ref_star)/(f2_nadir-z2_ref_star))-(bigm*y_6))
    ...
    m1.add_constraint(y_3+y_4==1)
    m1.add_constraint(y_5+y_6==1)
    ...
    #st.write(solve_details)
    #st.write('solution:' + str(nu_1.solution_value))
    ...
    choquet_11 = lambda_1_1*((objective[0].solution_value-z1_ref_star)/(f1_nadir-z1_ref_star))
    choquet_12 = lambda_1_2*((objective[1].solution_value-z2_ref_star)/(f2_nadir-z2_ref_star))
    choquet_21 = lambda_2_1*((objective[0].solution_value-z1_ref_star)/(f1_nadir-z1_ref_star))
    choquet_22 = lambda_2_2*((objective[1].solution_value-z2_ref_star)/(f2_nadir-z2_ref_star))

    st.subheader('Solution')
    #st.write('lambda1:' + str(lambda_1_1))
    #st.write('lambda2:' + str(lambda_1_2))
    ...
    #st.write('nu:' + str(nu.solution_value))
    ...
    #st.write('choquet_11:' + str(choquet_11))
    #st.write('choquet_12:' + str(choquet_12))
    #st.write('choquet_21:' + str(choquet_21))
    #st.write('choquet_22:' + str(choquet_22))

    #st.write('choquet_1:' + str(choquet_11+choquet_12))
    #st.write('choquet_2:' + str(choquet_21+choquet_22))
    ...
    optimizing_factor = nu_3.solution_value
    ...
    ax1.plot([z1_ref_star, z1_choquet_1, schnittpunkt_z1, z1_choquet_2, z1_ref_star], [z2_ref_star, z2_choquet_1, schnittpunkt_z2, z2_choquet_2, z2_ref_star], dashes=[6, 2], c='green', linewidth=1, label='Choquet metric')
    ...
    ax1.plot([z111_choquet_tschebycheff, z121_choquet_tschebycheff, z121_choquet_tschebycheff, z111_choquet_tschebycheff, z111_choquet_tschebycheff],
             ...
             linewidth=1, label='Tschebycheff Choquet metric')
